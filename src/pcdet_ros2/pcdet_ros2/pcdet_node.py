...
import sys
import os
openpcdet_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../OpenPCDet'))
...
class PCDetROS(Node):
    ...
    def __readConfig__(self):
        ...
        self.__net__.load_params_from_file(filename=self.__model_file__, logger=self.__logger__, to_cpu=not torch.cuda.is_available())
